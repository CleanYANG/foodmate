...
export const mockPlaces: MockPlace[] = [
  {
    ...
    shortReview: 'A calm café with soft jazz, creamy lattes, and a window view that makes snowy mornings feel cinematic.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'A compact late-night bar with friendly staff, crisp highballs, and a relaxed local crowd.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'A lively indoor market with seafood bowls, produce stalls, and plenty to snack on while browsing.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'Rich ramen, fast service, and exactly the kind of comforting meal you want on a cold day.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'A softly lit upper-floor restaurant with city views and a date-night atmosphere that feels easy, not stiff.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'A tiny bakery-café with buttery pastries and a neighborhood vibe that feels instantly welcoming.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'A classic sightseeing stop with a calmer surrounding area than expected and nice photo angles nearby.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'Bright espresso drinks, minimalist design, and a riverside location that feels fresh and modern.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'Bustling but friendly, with charcoal skewers and enough energy to make dinner feel like an event.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'A polished local market with cheese, sweets, and giftable food that does not feel overly touristy.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'Flavorful soup curry with tender vegetables and a spice level that is satisfying without being punishing.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'A sleek restaurant with candlelit tables and enough quiet to make conversation feel effortless.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'A hidden second-floor tea room with handmade desserts and a wonderfully unhurried pace.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'An easy scenic stop with wide city views, especially striking around sunset and after dark.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'Warm woods, excellent cheesecake, and a mellow soundtrack that makes staying longer feel reasonable.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'A polished cocktail bar with low lighting, thoughtful drinks, and a more intimate mood than the average nightlife stop.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'A seafood-forward market corridor that feels energetic early in the day and rewards hungry wandering.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'Smoky, lively, and exactly the kind of hands-on meal that makes dinner feel memorable.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'A quiet walking route lined with small trees and benches, ideal for a low-key detour from busier areas.',
    fullDescription:
  ...
  },
  {
    ...
    shortReview: 'A spacious park viewpoint with open skies and enough room to make even busy days feel breathable.',
    fullDescription:
